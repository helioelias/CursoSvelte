...
describe("MovieList", () => {
    ...
    it("renders a message when a search was made and no movies are returned", () => {
        ...
        const { getByText, debug } = render(MovieList);

        //debug(); //devolve o resultado
    ...
    it("renders movie list with 2 movies even when the list contains more movies but only 2 of then contain backdrop_path", () => {
    ...
    it("remove select from the first clicked card when a second card is clicked", async () => {
